...
func (in *NetworkInterfaceObs) DeepCopyInto(out *NetworkInterfaceObs) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkInterfaceObs.
func (in *NetworkInterfaceObs) DeepCopy() *NetworkInterfaceObs {
	if in == nil {
		return nil
	}
	out := new(NetworkInterfaceObs)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VPCEndpointObservation) DeepCopyInto(out *VPCEndpointObservation) {
	*out = *in
	...
	if in.NetworkInterfaces != nil {
		...
		*out = make([]NetworkInterfaceObs, len(*in))
		copy(*out, *in)
	}
}
